...
template<class Distribution1, class Distribution2>
Mixture<Distribution1, Distribution2>::Mixture(std::string input_file_name)
{
...
template<class Distribution1, class Distribution2>
double Mixture<Distribution1, Distribution2>::randNum() const
{
    double a, K, C;
    double nu, mu, lambda;
...
template<class Distribution1, class Distribution2>
double* Mixture<Distribution1, Distribution2>::getCharacteristics() const
{
...
template<class Distribution1, class Distribution2>
double Mixture<Distribution1, Distribution2>::getDensityFunctionOfX(double x) const
{
    return ((1 - p) * d1.getDensityFunctionOfX(x) + p * d2.getDensityFunctionOfX(x));
}

template<class Distribution1, class Distribution2>
void Mixture<Distribution1, Distribution2>::save(std::string output_file_name) const
{
...
template<class Distribution1, class Distribution2>
void Mixture<Distribution1, Distribution2>::load(std::string input_file_name)
{
    std::ifstream input_file;
    input_file.open(input_file_name);
    if (!input_file.is_open())
